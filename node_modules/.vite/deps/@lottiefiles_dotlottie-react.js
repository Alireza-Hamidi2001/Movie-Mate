...
var m = (d, i, r) => J3(d, typeof i != "symbol" ? i + "" : i, r);
var Y3 = class {
...
var G3 = class {
  constructor() {
    m(this, "_strategy"), this._strategy = typeof requestAnimationFrame == "function" ? new Y3() : new Z3();
  }
  requestAnimationFrame(d) {
...
var i0 = (() => {
  ...
  return function(i = {}) {
    var r, s = i, v, M, z = new Promise((t, e) => {
      v = t, M = e;
    }), D = Object.assign({}, s), G = "./this.program", E = "", l1;
    ...
    Object.assign(s, D), D = null, s.thisProgram && (G = s.thisProgram);
    var K = s.wasmBinary, q, s1 = false, h1, B, I, t1, J, L, w, f1, _1;
    function i1() {
      var t = q.buffer;
      s.HEAP8 = B = new Int8Array(t), s.HEAP16 = t1 = new Int16Array(t), s.HEAPU8 = I = new Uint8Array(t), s.HEAPU16 = J = new Uint16Array(t), s.HEAP32 = L = new Int32Array(t), s.HEAPU32 = w = new Uint32Array(t), s.HEAPF32 = f1 = new Float32Array(t), s.HEAPF64 = _1 = new Float64Array(t);
    }
    var E1 = [], H = [], v1 = [];
    function K2() {
    ...
    function n3(t, e, a = {}) {
      ...
      n1[t] = e, delete O1[t], c1.hasOwnProperty(t) && (e = c1[t], delete c1[t], e.forEach((o) => o()));
    }
    function V(t, e, a = {}) {
      return n3(t, e, a);
    }
    ...
    var M2 = (t, e, a) => {
    ...
    }, F, u3 = (t, e, a = []) => (t.includes("j") ? (t = t.replace(/p/g, "i"), e = (0, s["dynCall_" + t])(e, ...a)) : e = F.get(e)(...a), e), f3 = (t, e) => (...a) => u3(t, e, a), W = (t, e) => {
      t = k(t);
      var a = t.includes("j") ? f3(t, e) : F.get(e);
      ...
      function a(h) {
        o[h] || n1[h] || (O1[h] ? O1[h].forEach(a) : (n.push(h), o[h] = true));
      }
      var n = [], o = {};
...
` + n.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    var k3 = { d: (t, e, a, n) => F1(`Assertion failed: ${t ? p1(I, t) : ""}, at: ` + [e ? e ? p1(I, e) : "" : "unknown filename", a, n ? n ? p1(I, n) : "" : "unknown function"]), c: () => a3(), n: (t, e, a) => {
      var n = new g2(t);
      ...
      e1([t], h, (l) => {
        ...
        return o.forEach((u, f) => {
          var _ = l[f], p = u.sb, b = u.tb, U = l[f + o.length], P = u.zb, S = u.Bb;
          c[u.pb] = { read: (Q) => _.fromWireType(p(b, Q)), write: (Q, P1) => {
            var j = [];
            P(S, Q, U.toWireType(j, P1)), q1(j);
          } };
      ...
      e = k(e), V(t, { name: e, fromWireType: function(o) {
        return !!o;
      ...
      _ = k(_), h = W(o, h), c && (c = W(l, c)), f && (f = W(u, f)), b = W(p, b);
      var U = s3(_);
      Z1(U, function() {
        A1(`Cannot construct ${_} due to unbound types`, [n]);
      }), e1([t, e, a], n ? [n] : [], (P) => {
        if (P = P[0], n) var S = P.Qa, Q = S.$a;
        else Q = R1.prototype;
        P = C1(_, function(...d2) {
        ...
        var P1 = Object.create(Q, { constructor: { value: P } });
        P.prototype = P1;
        ...
        return S = new b1(_, j, true, false, false), S1 = new b1(_ + "*", j, false, false, false), Q = new b1(_ + " const*", j, false, true, false), C2[t] = { pointerType: S1, nb: Q }, M2(U, P), [S, S1, Q];
      });
    }, t: (t, e, a, n, o, h) => {
      var l = K1(e, a);
      o = W(n, o), e1([], [t], (c) => {
      ...
      var u = K1(a, n);
      e = k(e), e = S2(e), h = W(o, h), e1([], [t], (f) => {
        function _() {
          A1(`Cannot call ${p} due to unbound types`, u);
        }
        f = f[0];
        var p = `${f.name}.${e}`;
        e.startsWith("@@") && (e = Symbol[e.substring(2)]), c && f.Qa.xb.push(e);
        var b = f.Qa.$a, U = b[e];
        return U === void 0 || U.Sa === void 0 && U.className !== f.name && U.ab === a - 2 ? (_.ab = a - 2, _.className = f.name, b[e] = _) : (b2(b, e, p), b[e].Sa[a - 2] = _), e1([], u, (P) => (P = t2(p, P, f, h, l), b[e].Sa === void 0 ? (P.ab = a - 2, b[e] = P) : b[e].Sa[a - 2] = P, [])), [];
      });
    }, da: (t) => V(t, E2), y: (t, e, a, n) => {
      function o() {
      }
      e = k(e), o.values = {}, V(t, { name: e, constructor: o, fromWireType: function(h) {
        return this.constructor.values[h];
      }, toWireType: (h, l) => l.value, Wa: 8, readValueFromPointer: v3(e, a, n), Xa: null }), Z1(e, o);
    }, l: (t, e, a) => {
      var n = $1(t, "enum");
      e = k(e), t = n.constructor, n = Object.create(n.constructor.prototype, { value: { value: a }, constructor: { value: C1(`${n.name}_${e}`, function() {
      }) } }), t.values[a] = n, t[e] = n;
    }, E: (t, e, a) => {
      e = k(e), V(t, { name: e, fromWireType: (n) => n, toWireType: (n, o) => o, Wa: 8, readValueFromPointer: m3(e, a), Xa: null });
    }, v: (t, e, a, n, o, h) => {
      var l = K1(e, a);
      t = k(t), t = S2(t), o = W(n, o), Z1(t, function() {
        A1(`Cannot call ${t} due to unbound types`, l);
      }, e - 1), e1([], l, (c) => (M2(t, t2(t, [c[0], null].concat(c.slice(1)), null, o, h), e - 1), []));
    }, p: (t, e, a, n, o) => {
      if (e = k(e), o === -1 && (o = 4294967295), o = (c) => c, n === 0) {
        var h = 32 - 8 * a;
        o = (c) => c << h >>> h;
      }
      ...
      a = k(a), V(t, { name: a, fromWireType: n, Wa: 8, readValueFromPointer: n }, { vb: true });
    }, x: (t) => {
      V(t, g3);
    }, la: (t, e, a, n, o, h, l, c, u, f, _, p) => {
      a = k(a), h = W(o, h), c = W(l, c), f = W(u, f), p = W(_, p), e1([t], [e], (b) => (b = b[0], [new b1(a, b.Qa, false, false, true, b, n, h, c, f, p)]));
    }, ea: (t, e) => {
      e = k(e), V(t, { name: e, fromWireType: function(a) {
      ...
      if (a = k(a), e === 2) var n = w3, o = y3, h = L3, l = (c) => J[c >> 1];
      ...
      k1[t] = { name: k(e), ib: W(a, n), Ya: W(o, h), lb: [] };
    }, m: (t, e, a, n, o, h, l, c, u, f) => {
      k1[t].lb.push({ pb: k(e), ub: a, sb: W(n, o), tb: h, Ab: l, zb: W(c, u), Bb: f });
    }, ga: (t, e) => {
      e = k(e), V(t, { Db: true, name: e, Wa: 0, fromWireType: () => {
      }, toWireType: () => {
      } });
    }, O: () => {
      X1 = false, n2 = 0;
      ...
      throw 1 / 0;
    }, F: (t, e, a) => (t = W1(t), e = $1(e, "emval::as"), D2(e, a, t)), ja: (t, e, a, n) => (t = r2[t], e = W1(e), t(null, e, a, n)), M: i2, ia: (t, e, a) => {
      var n = P3(t, e), o = n.shift();
      t--;
      var h = Array(t);
      return e = `methodCaller<(${n.map((l) => l.name).join(", ")}) => ${o.name}>`, I3(C1(e, (l, c, u, f) => {
        for (var _ = 0, p = 0; p < t; ++p) h[p] = n[p].readValueFromPointer(f + _), _ += n[p].Wa;
      ...
      return w[n >> 2] = o, 0;
    }, $: Q3, aa: V3, J: N3, j: W3, i: B3, g: z3, ba: T3, z: H3, C: j3, D: $3, a: O3, b: R3, f: A3, o: U3, q: x3, G: X3, Y: O2, P: (t, e) => (R2(I.subarray(t, t + e)), 0) }, y;
    (async function() {
      function t(n) {
        return y = n.exports, q = y.ma, i1(), F = y.ra, H.unshift(y.na), a1--, s.monitorRunDependencies?.(a1), a1 == 0 && m1 && (n = m1, m1 = null, n()), y;
      }
    ...
    var h2 = (t) => (h2 = y.oa)(t), W2 = (t) => (W2 = y.pa)(t), Z = (t) => (Z = y.qa)(t), x2 = (t, e) => (x2 = y.sa)(t, e), O = (t, e) => (O = y.ta)(t, e), I1 = (t) => (I1 = y.ua)(t), T = (t) => (T = y.va)(t), R = () => (R = y.wa)(), $2 = (t, e, a) => ($2 = y.xa)(t, e, a);
    ...
    function j2() {
      function t() {
        if (!j1 && (j1 = true, s.calledRun = true, !s1)) {
          if (N1(H), v(s), s.onRuntimeInitialized?.(), s.postRun) for (typeof s.postRun == "function" && (s.postRun = [s.postRun]); s.postRun.length; ) {
...
var Z2 = class C {
  ...
  _getPointerPosition(i) {
    let r = this._canvas.getBoundingClientRect(), s = this._canvas.width / r.width, v = this._canvas.height / r.height, M = this._renderConfig.devicePixelRatio || window.devicePixelRatio || 1, z = (i.clientX - r.left) * s / M, D = (i.clientY - r.top) * v / M;
    return { x: z, y: D };
  }
  _onPointerUp(i) {
...
var _2 = class r1 {
  ...
  async _sendMessage(i, r, s) {
    let v = { id: `dotlottie-request-${N2()}`, method: i, params: r };
    return this._worker.postMessage(v, s || []), new Promise((M, z) => {
      let D = (G) => {
        let E = G.data;
        E.id === v.id && (this._worker.removeEventListener("message", D), E.error ? z(new Error(`Failed to execute method ${i}: ${E.error}`)) : M(E.result));
      };
  ...
  _getPointerPosition(i) {
    let r = this._canvas.getBoundingClientRect(), s = this._canvas.width / r.width, v = this._canvas.height / r.height, M = this._dotLottieInstanceState.renderConfig.devicePixelRatio || window.devicePixelRatio || 1, z = (i.clientX - r.left) * s / M, D = (i.clientY - r.top) * v / M;
    return { x: z, y: D };
  }
  _onPointerUp(i) {
    let { x: r, y: s } = this._getPointerPosition(i);
...
m(_2, "_workerManager", new c0()), m(_2, "_wasmUrl", "");
var H1 = _2;
var Q1 = ({ animationId: d, autoplay: i, backgroundColor: r, className: s, createDotLottie: v, data: M, dotLottieRefCallback: z, layout: D, loop: G, mode: E, playOnHover: l1, renderConfig: u1, segment: $, speed: K, src: q, style: s1, themeData: h1, themeId: B, useFrameInterpolation: I, workerId: t1, ...J }) => {
  let L = (0, import_react.useRef)(null), w = (0, import_react.useRef)(null), f1 = (0, import_react.useRef)(z), _1 = { speed: K, mode: E, loop: G, useFrameInterpolation: I, segment: $, backgroundColor: r, autoplay: i, themeId: B, workerId: t1, src: q, data: M, layout: D, renderConfig: u1, animationId: d }, i1 = (0, import_react.useRef)(_1);
  f1.current = z, i1.current = _1;
  let E1 = (0, import_react.useCallback)((H) => {
    w.current = H, H ? L.current = v({ ...i1.current, canvas: H }) : (L.current?.destroy(), L.current = null), f1.current?.(L.current);
  }, []);
  return (0, import_react.useEffect)(() => {
    ...
    L.current?.setLayout(D ?? {});
  }, [D?.fit, D?.align && D.align[0], D?.align && D.align[1]]), (0, import_jsx_runtime.jsx)("div", { className: s, ...!s && { style: { width: "100%", height: "100%", lineHeight: 0, ...s1 } }, children: (0, import_jsx_runtime.jsx)("canvas", { ref: E1, style: { width: "100%", height: "100%" }, ...J }) });
};
var u0 = (d) => new B1(d);
